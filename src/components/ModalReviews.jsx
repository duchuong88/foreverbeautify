...
let ItemsIpad = [
  {
    value: 1,
    desc: "Dissatisfaction",
    feedbacks: [
      "Disappointed with the service attitude of the staff",
      "Poor service quality",
      "Poor and outdated equipment",
      "The space and architecture are lackluster and unimpressive",
      "Hygiene quality is not satisfactory",
    ],
    feedSelected: [],
  },
  {
    ...
    feedbacks: [
      ...
      "Poor and outdated equipment",
      "The space and architecture are lackluster and unimpressive",
      "Hygiene quality does not meet requirements",
    ],
    feedSelected: [],
  },
  {
    ...
    desc: "Normal",
    feedbacks: [
      "The service attitude of the staff is not friendly",
      "Service quality is average",
      "Equipment is not up to standard",
      "The space is not impressive enough",
      "Hygiene quality is not good",
    ],
    feedSelected: [],
  },
  {
    ...
    feedbacks: [
      ...
      "Modern equipment",
      "Waiting time for service is a bit long",
      "Beautiful space, creating a comfortable feeling",
    ],
    feedSelected: [],
  },
  {
    ...
    desc: "Perfect",
    feedbacks: [
      "Staff attitude is very good",
      "Very satisfied with service quality",
      "Super fast customer service without having to wait",
      "Beautiful open space, attractive architecture",
      "Very satisfied and will come back with friends",
    ],
  },
];
        ...
        <div className="sheet-reviews-service__box">
          <div className="top">
            <div className="close" onClick={() => this.closeReviews()}>
              <img src={IconBlackClose} alt="Close" />
            </div>
            <div className="title">
              Service reviews (
              {arrReview &&
              ...
              {window.GlobalConfig?.APP?.isRateNote && (
                <div className="content-box__text">
                  <textarea
                    ...
                    placeholder="Share your review. Your review will be kept anonymous."
                    rows="2"
                  ></textarea>
                </div>
              )}
